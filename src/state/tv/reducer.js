...
const reducer = (state = tvInitialState, action) => {
    switch (action.type) {
        case tvActions.FETCH_TRENDING_TV_SUCCESS: return fetchTrendingTvSuccess(state, action)
        case tvActions.FETCH_TRENDING_TV_FAIL: return fetchTrendingTvFail(state, action)
        case tvActions.FETCH_TOP_TV_SUCCESS: return fetchTopTvSuccess(state, action)
        case tvActions.FETCH_TOP_TV_FAIL: return fetchTopTvFail(state, action)
