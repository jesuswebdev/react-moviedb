...
const reducer = (state = moviesInitialState, action) => {
  switch (action.type) {
    ...
    case moviesActions.FETCH_TRENDING_MOVIES_FAIL:
      return fetchTrendingMoviesFail(state, action);
    ...
    case moviesActions.FETCH_MOVIE_CAST_SUCCESS:
      return fetchMovieCastSuccess(state, action);
    case moviesActions.FETCH_MOVIE_CAST_FAIL:
      return fetchMovieCastFail(state, action);
    case moviesActions.SHOW_FULL_CAST:
      return showFullCast(state, action);
    case moviesActions.CLEAR_MOVIE_CAST:
      return clearMovieCast(state, action);
    case moviesActions.FETCH_TOP_MOVIES_SUCCESS:
      return fetchTopMoviesSuccess(state, action);
    case moviesActions.FETCH_TOP_MOVIES_FAIL:
      return fetchTopMoviesFail(state, action);
    case moviesActions.FETCH_PLAYING_MOVIES_SUCCESS:
      return fetchPlayingMoviesSuccess(state, action);
    case moviesActions.FETCH_PLAYING_MOVIES_FAIL:
      return fetchPlayingMoviesFail(state, action);
    case moviesActions.SELECT_TAB:
