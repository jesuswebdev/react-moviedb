...
class TvDetails extends Component {
  ...
  render() {
    ...
    const img = this.props.serie.poster_path
      ? IMG_URL + this.props.serie.poster_path
      : dummyImg;
      ...
      <div className="container" style={this.styles}>
        ...
        <div className="columns is-mobile is-centered">
          <div className="column is-10">
            {this.props.serie.created_by.length > 0 && (
              <Creators creators={this.props.serie.created_by} />
            )}
          </div>
        </div>
        <div className="columns is-mobile is-centered">
          <div className="column is-10">
            {this.props.cast && (
              <Cast
                cast={
                  this.props.isFullCast
                    ? this.props.cast
                    : this.props.cast.slice(0, 10)
                }
...
const mapDispatchToProps = dispatch => {
  return {
    fetchTvSerieDetails: id => {
      dispatch(tvActions.fetchTvDetails(id));
    },
    fetchTvCast: id => {
      dispatch(tvActions.fetchTvCast(id));
    },
    onClickShowFullCast: () => {
      dispatch(tvActions.onClickShowFullCast());
    },
    clearCast: () => {
      dispatch(tvActions.clearTvCast());
    }
  };
};
