    ...
    render() {
        return (
            <div className="container" style={this.styles}>
                <div className="columns is-mobile is-centered is-multiline" style={{paddingTop: '60px'}}>
                ...
                <div className="columns is-mobile is-centered is-multiline" style={{paddingTop: '50px'}}>
                    ...
                    <div className="column is-10-mobile is-5-tablet is-2-desktop">
                        ...
                        <p className="has-text-centered">
                            <Link to='/movies' className="button is-white">Go to Movies</Link>
                        </p>
                    </div>
                    ...
                    <div className="column is-10-mobile is-5-tablet is-2-desktop">
                        ...
                        <p className="has-text-centered">
                            <Link to='/tv' className="button is-white">Go to TV Shows</Link>
                        </p>
                    </div>
                    ...
                    <div className="column is-10-mobile is-5-tablet is-2-desktop">
                        ...
                        <p className="has-text-centered">
                            <Link to='/people' className="button is-white">Go to People</Link>
                        </p>
                    </div>
                    ...
                    <div className="column is-10-mobile is-5-tablet is-2-desktop">
                        ...
                        <p className="has-text-centered">
                            <Link to='/search' className="button is-white">Go to Search</Link>
                        </p>
                    </div>
                </div>
            </div>
